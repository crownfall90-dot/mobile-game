...
const SHOP := [
	{"id":"vita_plant", "name":"Зелёный друг", "text":"Цветок радует: +10 монет к каждой награде", "price":120},
	{"id":"vita_teddy", "name":"Мишка для дочки", "text":"С ним не страшно: в уровне одна ошибка прощается", "price":180},
	{"id":"vita_clothes", "name":"Семейное обновление", "text":"Тёплые наряды: не мёрзнут, звезда — 20 монет", "price":260},
	{"id":"vita_picture", "name":"Наши счастливые дни", "text":"Картина вдохновляет: +30 монет за новый ремонт", "price":220},
]
